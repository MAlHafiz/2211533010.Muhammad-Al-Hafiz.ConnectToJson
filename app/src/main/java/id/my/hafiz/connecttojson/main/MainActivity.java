package id.my.hafiz.connecttojson.main;
...
import id.my.hafiz.connecttojson.R;
import id.my.hafiz.connecttojson.adapter.AdapterPelanggan;
import id.my.hafiz.connecttojson.model.ModelPelanggan;
...
public class MainActivity extends AppCompatActivity {
    ...
    String base_url = "http://192.168.1.10/Belajar_API/customer.php";
